...
export const Stats = () => {
  ...
  return (
    <div id="stats" className="relative h-full overflow-hidden rounded-3xl bg-linear-to-b from-blue-500 to-white dark:to-black/20 border border-white/20 hover:border hover:border-blue-600  backdrop-blur-2xl p-6">
