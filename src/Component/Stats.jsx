...
export const Stats = () => {
  ...
  return (
    <div className="relative h-full overflow-hidden rounded-3xl bg-linear-to-b from-[#4fff75] to-black/20 border-2 border-white/20 hover:border hover:border-green-600  backdrop-blur-2xl p-6">
