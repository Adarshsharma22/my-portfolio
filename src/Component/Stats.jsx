...
export const Stats = () => {
  ...
  return (
    <div id="stats" className="relative h-full overflow-hidden rounded-3xl bg-linear-to-b from-green-400/50 to-black/20 border-2 border-white/20 hover:border hover:border-green-600  backdrop-blur-2xl p-6">
