      ...
      <div className="flex flex-wrap gap-4 justify-start overflow-y-auto no-scrollbar">
        {projects.map((project, index) => (
          <motion.div
            ...
            className="flex-1 min-w-[280px] group relative flex flex-col bg-white/50 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-2xl p-4 hover:shadow-lg dark:hover:bg-white/10 transition-all duration-300"
          >
            {/* Visual Header */}
