...
export const Hero = () => {
  return (
    <div className="relative bg-linear-to-b from-[#2626ff] to-black/20  backdrop-blur-2xl h-full overflow-hidden border-2 border-white/20 hover:border hover:border-blue-600 rounded-3xl p-5 group ">
