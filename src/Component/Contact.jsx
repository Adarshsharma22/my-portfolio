...
const [isHovered, setIsHovered] = useState(false);
  ...
  return (
    <div id="contact" className="relative h-full overflow-hidden rounded-3xl bg-background border border-border p-3 hover:border-purple-500/50 transition-colors">
